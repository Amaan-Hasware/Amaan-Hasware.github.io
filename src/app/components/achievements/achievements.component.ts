...
export class AchievementsComponent {
  ...
  secondary = [
    ...
    {
      title: 'AI Full-Stack Application',
      issuer: 'Key Project',
      description: 'Built a production React + Flask application powered by the Anthropic Claude API — live Smartsheet data ingestion, SSO authentication, and role-based access. Cut dev cycle time by 50%+.',
      metric: '50%+ faster',
    },
  ];
}
